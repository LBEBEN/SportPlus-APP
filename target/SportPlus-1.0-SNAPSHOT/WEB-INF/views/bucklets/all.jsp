...
<table border="1" bgcolor = #b0c4de>
    ...
    <c:forEach items="${bucklets}" var="bucklet" begin="0" end="${size-1}" varStatus="row">
        <tr align="center">
            <td>${row.index + 1}</td>
            ...
            <td><input type="button" onclick="location.href='/bucklet/edit/${bucklet.buckletId}';" value="EDYTUJ"/></td>
            <td><input type="button" onclick="location.href='/bucklet/delete/${bucklet.buckletId}';" value="USUŃ"/></td>
        </tr>
    </c:forEach>
